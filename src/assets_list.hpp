...
REGISTER_ASSET(bgmMenu,        Mix_Music,       "assets/music/james_gargette/kuia.mp3",              m, BGM    )
REGISTER_ASSET(bgmGame,        Mix_Music,       "assets/music/james_gargette/oioioioioioi.mp3",      m, BGM    )
