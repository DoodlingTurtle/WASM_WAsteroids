...
namespace RGNDS::Animation {
	...
	public:
		 ...
		 * \param deltaTime        - time that has passed, since the last onTimelinePlay command
		 *
		 ...
		 */
		virtual bool onTimelinePlay(float totalPlaytime, float relativePlaytime, float deltaTime) = 0;
